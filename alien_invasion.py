...
class AlienInvasion:
    ...
    def _update_bullets(self):
        ...
        # Getting rid of bullets that have reached the top of the screen.
    ...
    def _check_bullet_alien_collision(self):
        """Respond to bullet-alien collisions and remove aliens and bullets
        that have collided."""
    ...
    def _ship_hit(self):
        """Respond to a collision between the ship and an alien."""
